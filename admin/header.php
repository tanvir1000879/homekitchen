...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="admin-chef.php">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="admin-kitchen.php">
          <i class="fas fa-fw fa-house-user"></i>
          <span>Kitchens</span></a>
      </li>

      <li class="nav-item active">
        <a class="nav-link" href="admin-recipe.php">
              ...
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <?php
                  ...
                  while($row = $result->fetch_assoc()) { ?>
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$row['admin_name']?></span>
                <?php }
                ?>
              </a>
