              ...
              <div class="table-responsive">
                <table class="table table-bordered dataTable" id="" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    $sql= "SELECT * FROM hired WHERE user_id = '$id' AND status = 'Pending'";
                      ...
                      foreach ($result as $row) { ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a class="btn btn-sm btn-success" href="set_receiver.php?receiver_id=<?=$row['chef_id']?>">Chat</a>
              ...
              <div class="table-responsive">
                <table class="table table-bordered dataTable" id="" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    $sql= "SELECT * FROM hired WHERE user_id = '$id' AND status = 'Accepted'";
                    $result= $conn->query($sql);
              ...
              <div class="table-responsive">
                <table class="table table-bordered dataTable" id="" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    $sql= "SELECT * FROM hired WHERE user_id = '$id' AND status = 'Completed'";
                    $result= $conn->query($sql);
              ...
              <div class="table-responsive">
                <table class="table table-bordered dataTable" id="" width="100%" cellspacing="0">
                  ...
                  <?php
                    ...
                    $sql= "SELECT * FROM hired WHERE user_id = '$id' AND status = 'Cancelled'";
                    $result= $conn->query($sql);
