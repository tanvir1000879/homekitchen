...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="user-hire.php">
          <i class="fas fa-fw fa-list"></i>
          <span>Hiring Details</span></a>
      </li>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <?php
              ...
              $sql = "SELECT * FROM conversations WHERE user_id = '$id' AND status_u = '1'";
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <?php
                  $sql = "SELECT * FROM conversations WHERE user_id = '$id' AND status_u = '1' ORDER BY id DESC";
                  $result = $conn->query($sql);
              ...
              <?php
                    ...
                    foreach ($result as $row) { ?>
                      ...
                      <a class="dropdown-item d-flex align-items-center" href="set_receiver.php?receiver_id=<?=$row['chef_id']?>">
                        <div class="mr-3">
              ...
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <?php
                  ...
                  while($row = $result->fetch_assoc()) { ?>
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$row['user_name']?></span>
                <?php }
                ?>
              </a>
